const slides = [
  {
    ...
    imageMobile:
      'https://thechefkart.com/_next/image?url=https%3A%2F%2Fstorage.googleapis.com%2Fchefkart-strapi-media%2FChefit_Hero_banner_Mob_4658f2518d.webp&w=750&q=75',
    // title: '',
    subtitle: 'Forget ordering online! Get fresh food cooked in your kitchen.',
    button: 'Get Started',
  },
]
      ...
      <div className="relative z-10 flex items-center h-full">
        <div className="px-4 sm:px-8 md:px-12 lg:px-24 max-w-md sm:max-w-lg md:max-w-2xl">
          <h1 className="text-white text-2xl sm:text-3xl md:text-4xl font-bold mb-3 leading-snug">
            Get a Cook for One-Time <span className="text-orange-400">Within 60 Minutes</span>
          </h1>
